...
PRODUCT_COPY_FILES += \
    ...
    device/semc/shakira/prebuilt/xperience.png:system/usr/res/xperience.png \
...
PRODUCT_COPY_FILES += \
    ...
    device/semc/shakira/prebuilt/build:system/bin/build \
	device/semc/shakira/prebuilt/01cleanfilexXPE:system/etc/init.d/01cleanfilexXPE \
	device/semc/shakira/prebuilt/02GobernorXPE:system/etc/init.d/02GobernorXPE \
	device/semc/shakira/prebuilt/02XPEextrag:system/etc/init.d/02XPEextrag \
	device/semc/shakira/prebuilt/03VMSettXPE:system/etc/init.d/03VMSettXPE \
	device/semc/shakira/prebuilt/04XPEBTT:system/etc/init.d/04XPEBTT \
	device/semc/shakira/prebuilt/29XPEdalvik:system/etc/init.d/29XPEdalvik \
	device/semc/shakira/prebuilt/30XPEsmoothness:system/etc/init.d/30XPEsmoothness \
	device/semc/shakira/prebuilt/40zipalign:system/etc/init.d/40zipalign \
	device/semc/shakira/prebuilt/41xp:system/etc/init.d/41xp \
	device/semc/shakira/prebuilt/42optimizer:system/init.d/42optimizer \
	device/semc/shakira/prebuilt/60XPElgfx:system/etc/init.d/60XPElgfx \
	device/semc/shakira/prebuilt/707XPE_OPNGL:system/etc/init.d/707XPE_OPNGL \
	device/semc/shakira/prebuilt/sqlite_optimize:syste,/etc/init.d/sqlite_optimize \
